...
export const _appRelated = [
  ...
  const shortcut =
    (name === "Chrome" && getAssetPath("/assets/icons/app/ic_chrome.svg")) ||
    (name === "Drive" && getAssetPath("/assets/icons/app/ic_drive.svg")) ||
    (name === "Dropbox" && getAssetPath("/assets/icons/app/ic_dropbox.svg")) ||
    (name === "Evernote" &&
      getAssetPath("/assets/icons/app/ic_evernote.svg")) ||
    getAssetPath("/assets/icons/app/ic_github.svg");
